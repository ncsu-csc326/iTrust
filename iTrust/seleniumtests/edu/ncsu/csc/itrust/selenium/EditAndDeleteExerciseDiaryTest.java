...
public class EditAndDeleteExerciseDiaryTest extends iTrustSeleniumTest {
	...
	public void testEditExerciseDiaryEntryValidValues() throws Exception {
		...
		valDate = driver.findElement(By.name("Date:0"));
		assertEquals("12/13/2012", valDate.getValue());
		valType = driver.findElement(By.name("ExerciseType:0"));
		assertEquals("Weight Training", valType.getValue());
		valName = driver.findElement(By.name("Name:0"));
		assertEquals("Decline Bench Press", valName.getValue());
		valHours = driver.findElement(By.name("Hours:0"));
		assertEquals("0.75", valHours.getValue());
		valCalories = driver.findElement(By.name("Calories:0"));
		assertEquals("75", valCalories.getValue());
		valSets = driver.findElement(By.name("Sets:0"));
		assertEquals("4", valSets.getValue());
		valReps = driver.findElement(By.name("Reps:0"));
		assertEquals("8", valReps.getValue());
	...
	public void testDeleteExerciseDiaryEntry() throws Exception {
		...
		valDate = driver.findElement(By.name("Date:0"));
		assertEquals("12/12/2012", valDate.getValue());
		valType = driver.findElement(By.name("ExerciseType:0"));
		assertEquals("Cardio", valType.getValue());
		valName = driver.findElement(By.name("Name:0"));
		assertEquals("Running", valName.getValue());
		valHours = driver.findElement(By.name("Hours:0"));
		assertEquals("1.0", valHours.getValue());
		valCalories = driver.findElement(By.name("Calories:0"));
		assertEquals("100", valCalories.getValue());
		valSets = driver.findElement(By.name("Sets:0"));
		assertEquals("N/A", valSets.getValue());
		valReps = driver.findElement(By.name("Reps:0"));
		assertEquals("N/A", valReps.getValue());
