...
/*if ("removeLabProcedureForm".equals(submittedFormName)) {
    EditLabProceduresAction labProcedures = ovaction.labProcedures();
    
    String remID = request.getParameter("removeLabProcID");
    LabProcedureBean bean = new LabProcedureBean();
    bean.setProcedureID(Long.parseLong(remID));
    labProcedures.deleteLabProcedure(bean);
    ...
    ovaction.logOfficeVisitEvent(TransactionType.LAB_RESULTS_REMOVE);
...
if ("labProcedureForm".equals(submittedFormName)) {
	...
	try {
		...
		if (labtech==null || labtech.equals("")) {
			//bean = ovaction.labProcedures().autoAssignLabTech(bean);
