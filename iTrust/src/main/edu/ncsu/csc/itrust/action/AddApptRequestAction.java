...
public class AddApptRequestAction {
	...
	public String addApptRequest(ApptRequestBean bean) throws SQLException, DBException {
		...
		Timestamp apptTime = bean.getRequestedAppt().getDate();
		if(apptTime.before(new Timestamp(System.currentTimeMillis())))
			return "The scheduled date of this appointment ("+apptTime.toString()+") has already passed.";
