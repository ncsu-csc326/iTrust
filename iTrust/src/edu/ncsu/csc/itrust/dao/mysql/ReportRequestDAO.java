...
//	 * @throws DBException
//	 */
//	public void approveReportRequest(long ID, long approverMID, Date date) 
//						throws DBException {
//		Connection conn = null;
//		PreparedStatement ps = null;
//		try {
...
//			conn = factory.getConnection();
//			ps = conn.prepareStatement("UPDATE ReportRequests set ApproverMID = ?, 
//								ApprovedDate = ?, Status = 'Approved' where ID = ?");
...
//	 * @throws DBException
//	 */
//	public void rejectReportRequest(long ID, long approverMID, Date date, 
//						String comment) throws DBException {
//		Connection conn = null;
//		PreparedStatement ps = null;
//		try {
//			if (ID == 0L) throw new SQLException("ID cannot be null");
//			conn = factory.getConnection();
//			ps = conn.prepareStatement("UPDATE ReportRequests set ApproverMID = ?, 
//							ApprovedDate = ?, Status = 'Rejected', comment = ? where ID = ?");
//			ps.setLong(1, approverMID);
//			ps.setTimestamp(2, new java.sql.Timestamp(date.getTime()));
