...
(1,		'Diabetes',	'Andi',		CURDATE() - INTERVAL 40 YEAR,	'Female'),
/* Patient over 50, hasn't had flu shot this season */
(2,		'Flu',		'Bernard',	CURDATE() - INTERVAL 70 YEAR,	'Male'),
/* Female patient under 19 with overdue immunization for HPV. First immunization at 9 years */
(3,		'HPV',	'Crystal',	CURDATE() - INTERVAL 9 YEAR,	'Female')
...
(3,		CURDATE() - INTERVAL 2 YEAR,	9000000000, 'Checkup',	1)
ON DUPLICATE KEY UPDATE ID = ID;