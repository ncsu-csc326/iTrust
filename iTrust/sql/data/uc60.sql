...
INSERT INTO officevisits(id,visitDate,appt_type,HCPID,notes,HospitalID,PatientID,IsBilled) VALUES 
(2,'2012-03-08','General Checkup',9000000000,'Terrible cough.','9',311,true)
		 ON DUPLICATE KEY UPDATE id = id;

INSERT INTO billing(appt_id, billTimeS, PatientID, HCPID, amt, status) VALUES
(2, '2012-03-08', 311,9000000000,40,'Submitted');
 
INSERT INTO officevisits(id,visitDate,appt_type,HCPID,notes,HospitalID,PatientID,IsBilled) VALUES 
(3,'2013-12-02','General Checkup',9000000011,'Sean needs to lower his sodium intake.','9',311,true)
		 ON DUPLICATE KEY UPDATE id = id;

INSERT INTO billing(appt_id, billTimeS, PatientID, HCPID, amt, status) VALUES
(3, '2013-12-02', 311,'9000000011','40','Unsubmitted');
 
/* Scenario 5 - Louise Turner pays by credit card  */
INSERT INTO officevisits(id,visitDate,appt_type,HCPID,HospitalID,PatientID,IsBilled) VALUES 
(4,'2012-02-04','General Checkup',9000000011,'9',312,true)
		 ON DUPLICATE KEY UPDATE id = id;
INSERT INTO billing(appt_id, billTimeS, PatientID, HCPID, amt, status) VALUES
(4, '2012-02-04', 312,'9000000011','60','Unsubmitted');

/*Office Visit and Bill for John Smith*/
INSERT INTO officevisits(id, visitDate, appt_type, HCPID, notes, HospitalID, PatientID, IsBilled) VALUES
(5, '2014-01-10', 'General Checkup', 8000000011, 'Good job John, keep up the good work', '1', 313, true)
         ON DUPLICATE KEY UPDATE id = id;
INSERT INTO billing(appt_id, billTimeS, PatientID, HCPID, amt, status) VALUES
(5, '2014-01-10', 313, 8000000011, 150, 'Unsubmitted');

/*Office Visit and Bill for Maria Lopez*/
INSERT INTO officevisits(id, visitDate, appt_type, HCPID, notes, HospitalID, PatientID, IsBilled) VALUES
(6, '2014-02-17', 'Mammogram', 9000000000, 'Keep an eye on the area we discussed.', '4', 314, true)
         ON DUPLICATE KEY UPDATE id = id;
INSERT INTO billing(appt_id, billTimeS, PatientID, HCPID, amt, status) VALUES
(6, '2014-02-17', 314, 9000000000, 250, 'Unsubmitted');

/*Office Visit and Bill for Juan Carlos*/
INSERT INTO officevisits(id, visitDate, appt_type, HCPID, notes, HospitalID, PatientID, IsBilled) VALUES
(7, '2014-02-07', 'Ultrasound', 8000000011, 'Why are you getting an ultrasound?', '5', 315, true)
         ON DUPLICATE KEY UPDATE id = id;
INSERT INTO billing(appt_id, billTimeS, PatientID, HCPID, amt, status) VALUES
(7, '2014-02-07', 315, 8000000011, 350, 'Unsubmitted');

/*Office Visit and Bill for Alex Paul*/
INSERT INTO officevisits(id, visitDate, appt_type, HCPID, notes, HospitalID, PatientID, IsBilled) VALUES
(8, '2014-01-25', 'Colonoscopy', 9000000000, '', '9', 316, true)
         ON DUPLICATE KEY UPDATE id = id;
INSERT INTO billing(appt_id, billTimeS, PatientID, HCPID, amt, status) VALUES
(8, '2014-01-25', 316, 9000000000, 250, 'Unsubmitted');
