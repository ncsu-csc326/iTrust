...
public class LabProceduresTest extends iTrustHTTPTest {
	...
	public void testPatient_LabProcedureViewChart() throws Exception {
		...
		//Modified 9/23/2014 by Matt Witte
		//THIS TEST IS EFFECTIVELY USELESS AT THIS POINT; IT'S NOT TESTING WHAT IT SHOULD
		assertTrue(wr.getText().contains("Patient has no lab procedure data available from the past 3 years"));
	}
