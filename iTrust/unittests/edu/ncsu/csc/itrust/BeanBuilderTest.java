...
import edu.ncsu.csc.itrust.testutils.BadBean;
import edu.ncsu.csc.itrust.testutils.OkayBean;
...
public class BeanBuilderTest extends TestCase {
	...
	public void testNotOverloaded() throws Exception {
		try {
			...
			assertEquals(
					"edu.ncsu.csc.itrust.testutils.BadBean should not have any overloaded methods, like setThing",
					e.getMessage());
		}
	}
